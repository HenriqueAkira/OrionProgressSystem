...
public class EmployeeAccountConsoleView {
	...
	private static void setEployeeAccountInfomationForSimulation() {
		Office office = new Office("Gerente de TI",
				"O Gerente de Tecnologia da Informação (TI) é o profissional responsável por gerenciar projetos e operações de serviços de Tecnologia da Informação.",
	...
	private static void createCompanyAccountForSimulation() {
		Address address = new Address("01538-001", "Av. Lins de Vasconcelos", 1222,"", "Aclimação", "SP",
				"São Paulo");
